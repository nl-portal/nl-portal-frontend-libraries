...
const getContent = (collection: Array<object>, size: number) => {
...
export const getTaken = (
  ...
  const contentSliced = getContent(arrayTasks, pageSizeRequest);
...
export const getStartForms = (
  ...
  const contentSliced = getContent(
    arrayForms,
    pageSizeRequest ? pageSizeRequest : 0,
  );
