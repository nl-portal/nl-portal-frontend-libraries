...
export const EN_GB_MESSAGES: Messages = {
  [DEFAULT_LOCALES.ENGLISH]: {
    ...
    "pageTitles.products": "My products",
    ...
    "breadcrumb.products.details": "Details",
    ...
    "productsList.viewAll": "View all products ({total})",
    "productsList.empty": "There are no products.",
    "productsList.noClosedCases": "There are no products.",
    "productsList.fetchError": "Something went wrong, please try again later.",
