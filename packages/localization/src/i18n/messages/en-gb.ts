...
export const EN_GB_MESSAGES: Messages = {
  [DEFAULT_LOCALES.ENGLISH]: {
    ...
    "case.fetchError": "Something went wrong, please try again later.",
    ...
    "task.fetchError": "Something went wrong, please try again later.",
    ...
    "message.fetchError": "Something went wrong, please try again later.",
  },
};
