...
export const NL_NL_MESSAGES: Messages = {
  [DEFAULT_LOCALES.DUTCH]: {
    ...
    "pageTitles.products": "Mijn producten",
    ...
    "menu.menu-close-button": "Sluiten",
    "menu.authorized-login-label": "Ingelogd namens",
    "breadcrumb.overview": "Overzicht",
    "breadcrumb.cases": "Mijn zaken",
    "breadcrumb.cases.details": "Details",
    "breadcrumb.tasks": "Mijn taken",
    "breadcrumb.tasks.details": "Details",
    "breadcrumb.messages": "Mijn berichten",
    "breadcrumb.messages.details": "Details",
    "breadcrumb.products": "Mijn producten",
    "breadcrumb.products.details": "Details",
    "breadcrumb.account": "Mijn gegevens",
    "breadcrumb.account.editContactInfo": "Contactgegevens",
    "breadcrumb.account.editNotifications": "Meldingen",
    ...
    "caseDetails.resultAlert.afgehandeld": "De aanvraag is klaar",
    "caseDetails.resultAlert.verstrekt": "De aanvraag is goedgekeurd",
    "caseDetails.resultAlert.afgewezen": "De aanvraag is niet goedgekeurd",
    "caseDetails.resultAlert.geweigerd": "De aanvraag is geweigerd",
    "caseDetails.resultAlert.afgebroken": "De aanvraag is gestopt",
    "caseDetails.resultAlert.ingetrokken": "De aanvraag is teruggenomen",
