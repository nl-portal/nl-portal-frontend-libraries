...
export type DigitaleAdresResponse = {
  ...
  isGeverifieerd: Scalars['Boolean']['output'];
...
export type Query = {
  ...
  verificatieEnabled?: Maybe<Scalars['Boolean']['output']>;
};
...
export type CreateVerificatieMutationVariables = Exact<{
  verificatieCreateInput: VerificatieCreateInput;
}>;


export type CreateVerificatieMutation = { __typename?: 'Mutation', createVerificatie?: { __typename?: 'VerificatieCreateResponse', success: boolean, errorMessage?: string | null } | null };
...
export type VerifyVerificatieMutationVariables = Exact<{
  verificatieVerifyInput: VerificatieVerifyInput;
}>;


export type VerifyVerificatieMutation = { __typename?: 'Mutation', verifyVerificatie?: { __typename?: 'VerificatieVerifyResponse', verified: boolean, errorMessage?: string | null } | null };
...
export const CreateVerificatieDocument = gql`
  ...
  createVerificatie(verificatieCreateInput: $verificatieCreateInput) {
    ...
    `;
export type CreateVerificatieMutationFn = Apollo.MutationFunction<CreateVerificatieMutation, CreateVerificatieMutationVariables>;

/**
 * __useCreateVerificatieMutation__
 *
 * To run a mutation, you first call `useCreateVerificatieMutation` within a React component and pass it any options that fit your needs.
 * When your component renders, `useCreateVerificatieMutation` returns a tuple that includes:
 * - A mutate function that you can call at any time to execute the mutation
 * - An object with fields that represent the current status of the mutation's execution
 *
 * @param baseOptions options that will be passed into the mutation, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options-2;
 *
 * @example
 * const [createVerificatieMutation, { data, loading, error }] = useCreateVerificatieMutation({
 *   variables: {
 *      verificatieCreateInput: // value for 'verificatieCreateInput'
 *   },
 * });
 */
export function useCreateVerificatieMutation(baseOptions?: Apollo.MutationHookOptions<CreateVerificatieMutation, CreateVerificatieMutationVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useMutation<CreateVerificatieMutation, CreateVerificatieMutationVariables>(CreateVerificatieDocument, options);
      }
export type CreateVerificatieMutationHookResult = ReturnType<typeof useCreateVerificatieMutation>;
export type CreateVerificatieMutationResult = Apollo.MutationResult<CreateVerificatieMutation>;
export type CreateVerificatieMutationOptions = Apollo.BaseMutationOptions<CreateVerificatieMutation, CreateVerificatieMutationVariables>;
...
export const DoDirectPaymentDocument = gql`
    mutation DoDirectPayment($amount: PositiveFloat!, $identifier: String!, $langId: String, $orderId: String!, $reference: String!, $returnUrl: String) {
  doDirectPayment(
...
export const GenerateOgonePaymentDocument = gql`
    mutation GenerateOgonePayment($amount: PositiveFloat!, $failureUrl: String, $langId: String, $orderId: String!, $pspId: String!, $reference: String!, $successUrl: String, $title: String) {
...
export const VerifyVerificatieDocument = gql`
  ...
  verifyVerificatie(verificatieVerifyInput: $verificatieVerifyInput) {
    ...
    `;
export type VerifyVerificatieMutationFn = Apollo.MutationFunction<VerifyVerificatieMutation, VerifyVerificatieMutationVariables>;

/**
 * __useVerifyVerificatieMutation__
 *
 * To run a mutation, you first call `useVerifyVerificatieMutation` within a React component and pass it any options that fit your needs.
 * When your component renders, `useVerifyVerificatieMutation` returns a tuple that includes:
 * - A mutate function that you can call at any time to execute the mutation
 * - An object with fields that represent the current status of the mutation's execution
 *
 * @param baseOptions options that will be passed into the mutation, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options-2;
 *
 * @example
 * const [verifyVerificatieMutation, { data, loading, error }] = useVerifyVerificatieMutation({
 *   variables: {
 *      verificatieVerifyInput: // value for 'verificatieVerifyInput'
 *   },
 * });
 */
export function useVerifyVerificatieMutation(baseOptions?: Apollo.MutationHookOptions<VerifyVerificatieMutation, VerifyVerificatieMutationVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useMutation<VerifyVerificatieMutation, VerifyVerificatieMutationVariables>(VerifyVerificatieDocument, options);
      }
export type VerifyVerificatieMutationHookResult = ReturnType<typeof useVerifyVerificatieMutation>;
export type VerifyVerificatieMutationResult = Apollo.MutationResult<VerifyVerificatieMutation>;
export type VerifyVerificatieMutationOptions = Apollo.BaseMutationOptions<VerifyVerificatieMutation, VerifyVerificatieMutationVariables>;
...
/**
 * __useGetOpenProductHoofdThemasByProductenQuery__
 *
 * To run a query within a React component, call `useGetOpenProductHoofdThemasByProductenQuery` and pass it any options that fit your needs.
 * When your component renders, `useGetOpenProductHoofdThemasByProductenQuery` returns an object from Apollo Client that contains loading, error, and data properties
 * you can use to render your UI.
 *
 * @param baseOptions options that will be passed into the query, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options;
 *
 * @example
 * const { data, loading, error } = useGetOpenProductHoofdThemasByProductenQuery({
 *   variables: {
 *   },
 * });
 */
export function useGetOpenProductHoofdThemasByProductenQuery(baseOptions?: Apollo.QueryHookOptions<GetOpenProductHoofdThemasByProductenQuery, GetOpenProductHoofdThemasByProductenQueryVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useQuery<GetOpenProductHoofdThemasByProductenQuery, GetOpenProductHoofdThemasByProductenQueryVariables>(GetOpenProductHoofdThemasByProductenDocument, options);
      }
export function useGetOpenProductHoofdThemasByProductenLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<GetOpenProductHoofdThemasByProductenQuery, GetOpenProductHoofdThemasByProductenQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return Apollo.useLazyQuery<GetOpenProductHoofdThemasByProductenQuery, GetOpenProductHoofdThemasByProductenQueryVariables>(GetOpenProductHoofdThemasByProductenDocument, options);
        }
export function useGetOpenProductHoofdThemasByProductenSuspenseQuery(baseOptions?: Apollo.SkipToken | Apollo.SuspenseQueryHookOptions<GetOpenProductHoofdThemasByProductenQuery, GetOpenProductHoofdThemasByProductenQueryVariables>) {
          const options = baseOptions === Apollo.skipToken ? baseOptions : {...defaultOptions, ...baseOptions}
          return Apollo.useSuspenseQuery<GetOpenProductHoofdThemasByProductenQuery, GetOpenProductHoofdThemasByProductenQueryVariables>(GetOpenProductHoofdThemasByProductenDocument, options);
        }
export type GetOpenProductHoofdThemasByProductenQueryHookResult = ReturnType<typeof useGetOpenProductHoofdThemasByProductenQuery>;
export type GetOpenProductHoofdThemasByProductenLazyQueryHookResult = ReturnType<typeof useGetOpenProductHoofdThemasByProductenLazyQuery>;
export type GetOpenProductHoofdThemasByProductenSuspenseQueryHookResult = ReturnType<typeof useGetOpenProductHoofdThemasByProductenSuspenseQuery>;
export type GetOpenProductHoofdThemasByProductenQueryResult = Apollo.QueryResult<GetOpenProductHoofdThemasByProductenQuery, GetOpenProductHoofdThemasByProductenQueryVariables>;
